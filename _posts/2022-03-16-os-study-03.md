...
![Untitled](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/b44caae9-da70-413e-83cd-ff1535e7bbfc/Untitled.png)
...
<aside>
💡 프로세스의 문맥이란 프로세스 실행상태와 프로세스 자원 등 커널에서 관리하는 **프로세스 실행 정보**를  ****를 말한다.
